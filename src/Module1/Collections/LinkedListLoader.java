...
public class LinkedListLoader extends Methods {
    ...
    public void loader() throws FileNotFoundException {
        ...
        textToFile = String.format("%-15s%-8s%-12s%-12s%-12s%-12s%-12s%-15s%-15s%n", "|LinkedList", "|10K", timeForAdd10k, timeForGet10k, timeForRemove10k, timeForContains10k, timeForPopulate10k, timeForIteratorAdd10k, timeForIteratorRemove10k);
