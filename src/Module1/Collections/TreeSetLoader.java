...
public class TreeSetLoader extends Methods{
    ...
    public void loader() throws FileNotFoundException {
        ...
        textToFile = String.format("%-15s%-8s%-12s%-12s%-12s%-12s%-12s%-15s%-15s%n", "|TreeSet", "|10K", timeForAdd10k, timeForGet10k, timeForRemove10k, timeForContains10k,timeForPopulate10k, "-", "-");
